...
<head>
	...
	<!-- STYLES -->
	<link rel="stylesheet" type="text/css" href="old_lost.css">
</head>
<body>
		...
		<div class="container">
			<div class="actions-container clearfix">
				...
				<div class="actions-wrap orders-wrap pull-right">
					...
					<a href="#" class="action-item order-item active">Old</a>
				</div>
			</div>
			...
			<!-- First item-->
			<?php
				$sql = $pdo->query("SELECT * FROM lost ORDER BY id LIMIT 8")->fetchall(PDO::FETCH_ASSOC);
				foreach($sql as $row): ?>
